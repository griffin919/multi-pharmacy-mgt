<template>
  <div class="modal-body">
    ...
    <button @click="searchMasterList">search product</button>
  </div>
</template>
  ...
  methods: {
    ...
    async selectProduct(product) {
      try {
        ...
        // console.log('masterProductInfo',resList);
        this.masterProductInfo = resList[0];
        console.log("🚀 ~ selectProduct ~ masterProductInfo:", masterProductInfo)
